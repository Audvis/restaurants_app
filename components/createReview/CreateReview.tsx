...
const CreateReview: React.FC<IReview> = ( { slug } ) => {
    //state
    const [Review, setReview] = useState({restaurant: slug, rating: "", comments: "", email: ""});
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <div>
        ...
        <textarea name="comments" value={comments} onChange={updateReview}></textarea>
      </div>
      <div>
